...
{
    public partial class FrmFillFloodBFS : FrmBase
    {
        ...
        private void canvas_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                FloodFillBFS.floodFill(canvas, e.X, e.Y, bitmap);
                canvas.Image = bitmap;
            }
        }
        ...
        private void txtInner_TextChanged(object sender, EventArgs e)
        {
            //validate >= 10 && <= 200 for tb
            if (int.TryParse(txtInner.Text, out int inner))
            {
        ...
        {
            //validate >= 5 && <= 20
            if (int.TryParse(txtTips.Text, out int tips))
            {
                if (tips < 5)
                {
                    txtTips.Text = "5";
        ...
        private void FrmFillFloodBFS_Load(object sender, EventArgs e)
        {
